...
SECRET_KEY = "django-insecure-h9%62#*r(nj!&*@(iu(w#7r*3p6shaaxy=-_ga8*as77!rrp&$"
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            "string_if_invalid": "WARNING: {{%s}} not a valid context variable", # defaults to this if there's an invalid context var
            "context_processors": [
